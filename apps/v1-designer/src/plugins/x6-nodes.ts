...
export function registerVueNodes() {
  register({ shape: 'cooling-fan', component: CoolingFan })
  register({ shape: 'storage-tank', component: StorageTank })
  register({ shape: 'icon-node', component: IconNode })
  register({ shape: 'progress-node', component: ProgressBarNode })
  register({ shape: 'digital-node', component: DigitalNode })
  register({ shape: 'chart-node', component: ChartNode })
  register({ shape: 'table-basic', component: TableNode })
  register({ shape: 'list-rank', component: ListNode })
  register({ shape: 'timeline-h', component: TimelineNode })
  register({ shape: 'countdown', component: CountDownNode })
  register({ shape: 'gauge-node', component: GaugeNode })
  register({ shape: 'alert-node', component: AlertNode })
}
